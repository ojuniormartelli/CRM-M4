...
const CRM_FIELDS = [
  ...
  { id: 'proposed_ticket', label: 'Ticket Proposto', aliases: ['proposed_ticket', 'ticket proposto', 'valor proposto', 'valor_proposto'] },
  { id: 'temperature', label: 'Temperatura do Lead', aliases: ['temperature', 'temperatura', 'temp', 'calor'] },
  { id: 'probability', label: 'Probabilidade (%)', aliases: ['probability', 'probabilidade', 'prob', 'chance'] },
  { id: 'qualification', label: 'Qualificação', aliases: ['qualification', 'qualificacao', 'qualif', 'rating'] },
  { id: 'ai_score', label: 'Pontuação IA', aliases: ['ai_score', 'score ia', 'pontuacao ia', 'score'] },
  { id: 'ai_reasoning', label: 'Raciocínio IA', aliases: ['ai_reasoning', 'raciocinio ia', 'reasoning'] },
  { id: 'next_action', label: 'Próxima Ação', aliases: ['next_action', 'proxima acao', 'acao', 'next action'] },
  { id: 'next_action_date', label: 'Data Próxima Ação', aliases: ['next_action_date', 'data proxima acao', 'data acao', 'action_date'] },
  { id: 'closing_forecast', label: 'Previsão de Fechamento', aliases: ['closing_forecast', 'previsao fechamento', 'previsao', 'forecast'] },
